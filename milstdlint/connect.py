"""Native cognis-connect emit for milstdlint — forward findings to any platform.

Maps milstdlint's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    milstdlint ... --format json | milstdlint-emit --to stix
    milstdlint-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
