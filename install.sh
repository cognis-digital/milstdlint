#!/usr/bin/env sh
# Universal installer for milstdlint. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/milstdlint.git"
echo "Installing milstdlint ..."
